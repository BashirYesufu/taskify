        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Overview', style: AppTextStyles.medium(context, secondary: true),),
                SizedBox(height: 4),
                Row(
                  children: [
                    Flexible(
                      ...
                      child: AppCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Completed Projects', style: AppTextStyles.regular(context, secondary: true),),
                          ],
                        ),
                      ),
                    ),
          ...
          Expanded(
            child: Column(
              children: [
                Row(
                  children: [
                    Text('Projects', style: AppTextStyles.medium(context, secondary: true),),
                    InkWell(
